...
generate() {
    ...
    python $(which fairseq-generate) $data \
        ...
        --task translation  \
        -s $src -t $tgt \
        --remove-bpe 'sentencepiece' > $translation.log
    
    cat $translation.log | grep -P "^H" |sort -V |cut -f 3- > $translation 
...
must_she_ref='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/must_she_data/cat.test'
...
flores_dev='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/data-bin-tests/flores_dev_uni'
flores_devtest='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/data-bin-tests/flores_devtest_uni'
must_she='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/data-bin-tests/must_she_data_uni'
