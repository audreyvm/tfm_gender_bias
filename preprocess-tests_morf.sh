...
dict='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/data-bin-morf_j_sample/dict.en.txt'
for data_dir in $flores_dev_dir $flores_devtest_dir $must_she_dir
do
    python morfessor_lines.py ${data_dir}/test.en  ${data_dir}/test.morf.en
    python morfessor_lines.py ${data_dir}/test.ca  ${data_dir}/test.morf.ca
done
...
#Flores dev
dest_dir='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/data-bin-tests/flores_dev_morf'
rm -r $dest_dir
mkdir -p $dest_dir
dict_dir=$dict
...
#Flores devtest
dest_dir='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/data-bin-tests/flores_devtest_morf'
rm -r $dest_dir
mkdir -p $dest_dir
dict_dir=$dict
...
#Must_She
dest_dir='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/data-bin-tests/must_she_data_morf'
rm -r $dest_dir
mkdir -p $dest_dir
dict_dir=$dict
