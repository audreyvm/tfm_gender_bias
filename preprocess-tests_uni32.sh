...
dict='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/data-bin-uni32/dict.en.txt'
model='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/data/model.model'
model_type='uni32'

for data_dir in $flores_dev_dir $flores_devtest_dir $must_she_dir
do
    python spm_encode.py --model ${model} --inputs ${data_dir}/test.ca --outputs ${data_dir}/test.${model_type}.ca
    python spm_encode.py --model ${model} --inputs ${data_dir}/test.en --outputs ${data_dir}/test.${model_type}.en
done
...
#Flores dev
dest_dir='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/data-bin-tests/flores_dev_uni'
rm -r $dest_dir
mkdir -p $dest_dir
dict_dir=$dict
...
#Flores devtest
dest_dir='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/data-bin-tests/flores_devtest_uni'
rm -r $dest_dir
mkdir -p $dest_dir
dict_dir=$dict
...
#Must_She
dest_dir='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/data-bin-tests/must_she_data_uni'
rm -r $dest_dir
mkdir -p $dest_dir
dict_dir=$dict
