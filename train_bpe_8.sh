#!/bin/bash
#SBATCH --job-name=train_mt_ca_en_bpe8
#SBATCH --output=slurm_logs/train_mt_ca_en_bpe8_%j.out
#SBATCH --error=slurm_logs/train_mt_ca_en_bpe8_%j.err
#SBATCH --ntasks=1
#SBATCH --gres gpu:1
...
data_dir='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/data-bin-bpe8'
save_dir='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/checkpoints/caen-bpe8/'
src='ca'
tgt='en'
