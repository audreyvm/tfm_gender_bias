#!/bin/bash
#SBATCH --job-name=train_mt_en_ca_char
#SBATCH --output=slurm_logs/train_mt_en_ca_char_%j.out
#SBATCH --error=slurm_logs/train_mt_en_ca_char_%j.err
#SBATCH --ntasks=1
#SBATCH --gres gpu:1
...
data_dir='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/data-bin-char'
save_dir='/gpfs/scratch/bsc88/bsc88400/tfm_gender_bias/checkpoints/enca-char/'
src='en'
tgt='ca'
